<p align="center">
  ...
  <p align="center" style="align: center;">
      ...
      <a href="https://bundlephobia.com/package/connect2mongodb@1.1.41">
         <img src="https://img.shields.io/bundlephobia/min/connect2mongodb@1.1.41" alt="Size" />
      </a>
   </p>
</p>
...
Make sure you must have installed exact same version i.e.:- **mongoose@8.6.4,** in NextJS/Express Server.

```js
npm i mongoose@8.6.4
```
